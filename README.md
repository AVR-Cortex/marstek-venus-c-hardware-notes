...
- The 12V on the secondary side is converted to 5V using a small buck converter. The 3.3V for the MCU and WiFi module is generated by a small linear regulator from the 5V rail.
