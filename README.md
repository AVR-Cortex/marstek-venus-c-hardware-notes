...
- The BMS is connected to the Control PCB via CAN bus and RS485. This RS485 connection is the same as the external RS485. The function of the RS485 connection is somewhat unclear. The whole device is a Modbus slave, maybe the BMS answers on some adresses and the Control on others. As long as there is Modbus communication, the device does not shut down. Maybe the RS485 connection is used as keep-awake function.
